  ...
  <v-toolbar dark color="primary">
    <v-menu class="hidden-md-and-up">
          ...
          <v-list two-line>
            ...
            <router-link to="/lista-salas" v-if="menu.listaSalas">
            <v-list-tile avatar>
              <v-list-tile-content>
                <v-list-tile-title>Salas</v-list-tile-title>
              </v-list-tile-content>
            </v-list-tile>
            </router-link>
